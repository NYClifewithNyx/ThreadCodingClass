...
public abstract class Effects {
    ...
    //System.out.println(Effects.STROKE + "TEST 하는 중" + Effects.RESET); < 이런 식으로 앞에 class명 붙여넣어주어야 하는듯.
    ...
    public static void blinkFast(long ms) {
        for (int i = 0; i < 20; i++) {
            System.out.print("▼");
            System.out.flush();
            sleep(80); //위의 sleep을 씀. 다른 곳에서 쓸 때는 Effects.sleep으로 불러와줘야함
...
//public class TypeEffects extends Effects { //실제로 서브 클래스 없는데 이런 식으로 만들면 에러가 나는구나
//
//
//}
